...
const { createRdvSchema, updateRdvStatutSchema, demandePaiementRdvSchema } = require('../validations/rendezvous.validation');
...
router.post('/demande-paiement', authenticate, requireRole('patient', 'usager'), validate(demandePaiementRdvSchema), rendezvousController.demandePaiement);
